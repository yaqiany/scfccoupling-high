function mappedX = diffusion_maps(X, no_dims, alpha, sigma)
%DIFFUSION_MAPS Runs the diffusion map algorithm
%
%   mappedX = diffusion_maps(X, no_dims, alpha, sigma)
%
...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    disp('Compute Markov forward transition probability matrix ...');
    sumX = sum(X .^ 2, 2);
